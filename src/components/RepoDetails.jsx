...
//       variables: { owner: userName, name: gitRepo }, // Corrected variable name to "owner"
//     });
...
//   console.log('Commits:', repository.commits?.target);
//   return (
//     <>
//       <div>
...
//         <p>Default branch: {repository.defaultBranchRef.name}</p>
//         <p>Stars: {repository.stargazers.totalCount}</p>
//         <p>Watchers: {repository.watchers.totalCount}</p>
//         {/* Render commit history and branch details */}
...
//             <p>Committed Date: {commit.committedDate}</p>
...
//             <p>Commit Count: {branch.target.history.totalCount}</p>
//           </div>
//         ))}
//       </div>
//     </>
